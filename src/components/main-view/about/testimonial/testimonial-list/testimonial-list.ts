...
export const testimonialList:ITestimonial[] = [
  { id: 0, position: 'CFO', relation: 'Direct manager', testimonial: 'Excellent professional, experienced with systems and reports. Does not limit himself to user needs but seeks to understand the needs of all departments!' },
