...
export default function TestimonialCard({ position, relation, testimonial, href }: Props) {
  ...
  return (
    <div className="group container relative w-[300px] h-[450px] max-lg:m-auto md:w-[400px] md:h-[700px] lg:w-[300px] lg:h-[450px] xl:w-[400px] xl:h-[700px] scale-90 rounded-xl bg-background-div1 p-4 text-center shadow-lg shadow-translucid-black duration-300 hover:scale-95 sm:p-7 md:p-8 lg:p-4 xl:p-8">
