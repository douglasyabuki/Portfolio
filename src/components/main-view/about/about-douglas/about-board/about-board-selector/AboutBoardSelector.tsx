...
export default function AboutBoardSelector({icon, title, onClickHandler }: Props) {
  return (
    <div
      role={'button'}
    ...
    >
      <i className={`${icon} flex w-6 items-center justify-center xs:text-lg md:text-xl 2xl:text-2xl 3xl:text-3xl group-hover:animate-spin`}></i>
