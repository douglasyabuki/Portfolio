...
import ContactButton from './buttons/contact-button/ContactButton';
...
export default function Home() {
  ...
  return (
    ...
    >
      <div className="custom-bg-1 block items-center rounded-2xl p-2 shadow-lg shadow-translucid-black sm:p-7 md:rounded-2xl md:p-8 lg:flex lg:p-10">
        <div className="container block px-4 text-center align-middle md:px-16 lg:text-left xl:px-12">
          ...
          <div className="container my-4 flex h-auto flex-col justify-center items-center gap-4 md:my-12 md:flex-row md:gap-4 lg:my-4 lg:justify-start">
